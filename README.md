...
|---|---|---|
| **[JavaAppStudy · Backend](https://github.com/jesusvalenciaalcivar-ml/java-appstudy-backend)** | API REST de la plataforma: autenticación con JWT, gestión de lecciones, progreso y logros. Modelo de datos relacional propio. | Java · Spring Boot · PostgreSQL · JWT|
